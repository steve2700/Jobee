    ...
    return (
        <div className="border rounded-lg shadow px-4 py-2 space-y-4">
            ...
            <div className="flex flex-col">
                <span className="text-2xl font-bold">{details.role}</span>
            ...
            <div className="flex justify-between mx-3">
                <button className="border rounded-lg px-4 py-1 border-[#6300B3] text-[#6300B3] font-semibold">View Details</button>
